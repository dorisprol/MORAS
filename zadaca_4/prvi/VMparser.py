class Parser:
    ...
    def _parseLine(self, line, n):
        ...
        if l[0] == "push":
            ...
            if l[0] == "label" and len(l) == 2:
                ...
                if l[1] in self._labels:
                    return "//" + " ".join(l) + "\n" + self._goto(l[1], n)
                Parser._error("Goto", n, "Non-existent label.")
                return "" 
            elif l[0] == "if-goto" and len(l) == 2:
                if l[1] in self._labels:
                    return "//" + " ".join(l) + "\n" + self._ifgoto(l[1], n)
                Parser._error("If-goto", n, "Non-existent label.")
                return "" 
    ...
    def _push(self, src, loc, n):
        ...
        try:
            ...
            Parser._error("Push", n, "Invalid argument.")
            return ""
        if loc < 0:
            Parser._error("Push", n, "Invalid argument.")
            return ""            
    ...
    def _pop(self, dst, loc, n):
        ...
        try:
            ...
            Parser._error("Pop", n, "Invalid argument.")
            return ""
        if loc < 0:
            Parser._error("Pop", n, "Invalid argument.")
            return ""            
